  ...
  1: [
    {
      ...
      sender: "Cook A",
      isUser: false,
      text: "My withdrawal request is pending. It's been 3 days already.",
      time: "10:20 AM",
    },
    {
      id: 2,
      sender: "Admin",
      isUser: true,
      text: "I'll check on that right away. Can you provide your request number?",
      time: "10:22 AM",
    },
    {
      id: 3,
      sender: "Cook A",
      isUser: false,
      text: "Sure, it's #WD-24601. Thank you for the quick response!",
      time: "10:25 AM",
    },
  ],
  2: [
    {
      ...
      sender: "Customer X",
      isUser: false,
      text: "Hello, I placed order #45678 an hour ago and haven't received it yet.",
      time: "9:35 AM",
    },
    {
      id: 2,
      sender: "Admin",
      isUser: true,
      text: "I apologize for the delay. Let me check the status for you.",
      time: "9:38 AM",
    },
    {
      id: 3,
      sender: "Admin",
      isUser: true,
      text: "I see that your order is currently being prepared. The kitchen is experiencing higher volume than usual today.",
      time: "9:39 AM",
    },
    {
      id: 4,
