			...
			<main className="container mx-auto px-6 py-8">
				...
				{cook?.intro_video_url && (
					<div className="mt-6">
						...
						>
							<source
								src={`${videoBaseUrl}${cook.intro_video_url}`}
								type="video/mp4"
							/>
						</video>
					</div>
						...
						<>
							...
							{cook?.available_status === "offline" ? (
								<div className="p-6 bg-yellow-100 text-yellow-800 rounded-lg shadow">
									This cook is currently <strong>offline</strong>. You cannot
									order items at the moment.
								</div>
							) : (
								<CookCategories
									cookId={cook?.id}
									...
									disabled={cook?.available_status === "offline"}
								/>
							)}
						</>
					)}
