  ...
  useEffect(() => {
    const initializeLocation = async () => {
      ...
      try {
        ...
        if (!response?.data) {
          console.log(
            "No cook location data found (data is null), requesting location via browser"
          );
          ...
          console.log(
            "Unexpected data format in response, trying browser geolocation"
          );
          await fetchLocation();
        }
      } catch (error) {
        ...
        console.log(
          "Error checking existing location, trying browser geolocation"
        );
        await fetchLocation();
      } finally {
        setIsCheckingExistingLocation(false);
