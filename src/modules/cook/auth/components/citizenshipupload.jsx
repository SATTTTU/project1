...
export const CitizenshipUploadStep = ({ formik }) => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-gray-800">Upload Citizenship Documents</h2>
      <p className="text-gray-600">Please upload clear images of your citizenship documents.</p>
      
      <div className="space-y-4">
        {/* Passport-sized photo */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Passport-sized Photo</label>
          <div 
        ...
        {/* Front side upload */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Citizenship Front Side</label>
          <div 
            className="mt-1 flex items-center justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md cursor-pointer hover:bg-gray-50 transition-colors"
        ...
        {/* Back side upload */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Citizenship Back Side</label>
          <div 
            className="mt-1 flex items-center justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md cursor-pointer hover:bg-gray-50 transition-colors"
