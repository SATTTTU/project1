...
export const ProfileCard = ({ userData }) => {
	...
	const [imagePreview, setImagePreview] = useState(
		userData?.image || "/api/placeholder/200/200"
	);
				...
				<div className="container mx-auto px-4">
					<div className="flex flex-col md:flex-row items-center justify-between py-6">
							...
							<div className="relative">
								<div className="p-1 rounded-full transition-transform duration-200 hover:scale-105">
									<img
										...
										alt="Profile"
										className="rounded-full h-20 w-20 object-cover shadow-md border-2 border-white transition-all duration-300"
									/>
								</div>
								{isEditMode && (
									<label
						...
						<form
							...
							className="w-full md:w-auto flex-grow md:ml-6 mt-4 md:mt-0"
						>
