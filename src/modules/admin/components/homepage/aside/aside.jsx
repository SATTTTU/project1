...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar Overlay */}
      <div
        className={`fixed inset-0 bg-black bg-opacity-50 z-40 transition-opacity duration-300 ${showSidebar ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'}`}
        onClick={handleToggleSidebar}
      ></div>
