      ...
      <div className="md:w-4/5 p-6 overflow-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="text-sm text-green-500 mt-2">
              {
                filteredTransactions.filter((t) => t.amount.startsWith("+"))
                  .length
              }{" "}
              transactions
            </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="text-sm text-orange-500 mt-2">
              {
                filteredTransactions.filter((t) => t.status === "Processing")
                  .length
              }{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link
            ...
            className="block p-6 bg-white shadow-md rounded-xl hover:shadow-lg transition border-l-4 border-green-500"
          >
            ...
            <p className="text-gray-600 mb-3">
              Generate and manage user payment invoices.
            </p>
          ...
          <Link
            ...
            className="block p-6 bg-white shadow-md rounded-xl hover:shadow-lg transition border-l-4 border-gray-500"
          >
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-lg font-semibold text-gray-800">
            ...
            <p className="text-gray-600 mb-3">
              Configure user payment methods and options.
            </p>
