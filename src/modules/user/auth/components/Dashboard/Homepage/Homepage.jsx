...
// Sample data
const categories = [
  { name: "Burgers & Fast",  img: "/placeholder.svg?height=80&width=80" },
  { name: "Salads", img: "/placeholder.svg?height=80&width=80" },
  { name: "Pasta & Cousous", img: "/placeholder.svg?height=80&width=80" },
  { name: "Pizza", img: "/placeholder.svg?height=80&width=80" },
  { name: "Breakfast", img: "/placeholder.svg?height=80&width=80" },
  { name: "Soups", img: "/placeholder.svg?height=80&width=80" },
]

const cooks = [
  { name: "Ram Singh", img: "/placeholder.svg?height=80&width=80" },
  { name: "Sushma Singh", img: "/placeholder.svg?height=80&width=80" },
  { name: "Arpita Thapa", img: "/placeholder.svg?height=80&width=80" },
  { name: "Tawas Mom", img: "/placeholder.svg?height=80&width=80" },
  { name: "Rupger Ki", img: "/placeholder.svg?height=80&width=80" },
  { name: "Shaurma I", img: "/placeholder.svg?height=80&width=80" },
]

const popularItems = [
  { name: "Cheese Burger", price: "11.88", img: "/placeholder.svg?height=200&width=400" },
  { name: "Pancake", price: "11.99", img: "/placeholder.svg?height=200&width=400" },
  { name: "Crispy Sandwich", price: "13.99", img: "/placeholder.svg?height=200&width=400" },
]
