...
export const Sidebar=()=> {
  return (
    <div className="w-64 bg-white border-r flex flex-col">
      ...
      {/* Upgrade Account */}
      <div className="p-4 m-4 bg-yellow-500 rounded-xl text-white">
        <h3 className="font-semibold">Upgrade your Account to Get Free Voucher</h3>
        <button className="mt-4 bg-white text-yellow-500 px-4 py-2 rounded-lg text-sm font-medium">Upgrade</button>
      </div>
    </div>
  )
}
  ...
  return (
    <Link
      ...
      className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
        active ? "bg-yellow-500 text-white" : "text-gray-600 hover:bg-yellow-50"
      }`}
    >
      {icon}
