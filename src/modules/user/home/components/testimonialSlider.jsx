	...
	return (
		<section className="py-8 px-4 md:px-8 lg:px-16 ">
			<div className="container mx-auto">
				<h2 className="text-3xl font-bold text-center text-[#0e9300] mb-6">
					Customer Reviews
				</h2>
						...
						>
							<div className="swiper-wrapper equal-height-slides ">
								{testimonials?.map((testimonial) => (
									<SwiperSlide
										key={testimonial.id}
										className="h-auto border border-slate-300 rounded-lg"
									>
										<div className="bg-white p-10 rounded-lg shadow-xl flex flex-col h-[400px] lg:h-[330px]">
											<div className="flex items-center mb-4">
												...
												/>
												<div>
													<h3 className="font-semibold">{testimonial.comment}</h3>
