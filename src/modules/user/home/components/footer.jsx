                  ...
                  <div className="container mx-auto text-center px-4 md:px-2">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      <div className="col-span-1 lg: flex flex-col ">
                        <Link to="/" className="flex items-center justify-center mb-4 lg:text-left">
                          <img src={Logo} alt="KhanaBox Logo" width={40} height={40} className="" />
                      ...
                      <div className="col-span-1">
                        <h3 className="text-xl font-semibold mb-4 text-[#426B1F]">Legal Pages</h3>
                      ...
                      <div className="col-span-1">
                        <h3 className="text-xl font-semibold text-[#426B1F] mb-4">Important Links</h3>
                        <ul className="space-y-2">
                          <li>
                            <Link to="#" className="text-gray-600 hover:text-green-600">
                              FAQ
                          ...
                          <li>
                            <Link to="/user/register" className="text-gray-600 hover:text-green-600">
                          ...
                          <div className="col-span-1 lg:text-center">
                                <h3 className="text-xl font-semibold  text-[#426B1F]">Contact Us</h3>
