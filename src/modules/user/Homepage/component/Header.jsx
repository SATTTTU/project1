              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 border">
                  <div className="px-4 py-3 border-b">
                    ...
                    <p className="text-xs text-gray-500 truncate">name@example.com</p>
                  </div>

                  <Link to="/user/profile" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                    <AiOutlineUser className="mr-2 text-gray-500" />
                    Your Profiles
                  </Link>

                  <Link to="/user/orders" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                    <AiOutlineShoppingCart className="mr-2 text-gray-500" />
                    Your Orders
                  </Link>

                  <Link to="/user/favourite" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                    <AiOutlineHeart className="mr-2 text-gray-500" />
                    Wishlist
                  </Link>

                  <Link to="/user/setting" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
