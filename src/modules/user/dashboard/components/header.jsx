...
import LogoutForm from "../../auth/forms/LogoutForm"; 
            ...
            <div className="container mx-auto px-4 py-3">
                <div className="flex items-center justify-between">
                    <Link to="/user/dashboard" className="flex items-center">
                        ...
                        <span className="text-2xl font-bold text-[#426B1F]">KhanaBoxsss</span>
                    </Link>
                        ...
                        <div className="relative" ref={profileRef}>
                            ...
                            {showProfileMenu && (
                                <div className="absolute right-0 lg:p-2 mt-2 w-48 bg-white rounded-md shadow-xl py-1 z-50 border border-slate-200">
                                    ...
                                    <Link to="/profile" className="flex items-center px-4 py-2 text-sm text-gray-900 hover:bg-gray-200 rounded-sm">
                                        <FaUserCircle className="mr-3 h-5 w-5 " />
                                        Your Profile
                                    </Link>

                                    <Link to="/profile/order" className="flex items-center px-4 py-2 text-sm text-gray-900 hover:bg-gray-200 rounded-sm">
                                        <AiOutlineShoppingCart className="mr-3 h-5 w-5 " />
                                        Your Orders
                                    </Link>

                                    <Link to="/profile/wishlist" className="flex items-center px-4 py-2 text-sm text-gray-900 hover:bg-gray-200 rounded-sm">
                                        <AiOutlineHeart className="mr-3 h-5 w-5 " />
                                        Wishlist
                                    </Link>

                                    <Link to="/profile/settings" className="flex items-center px-4 py-2 text-sm text-gray-900 hover:bg-gray-200 rounded-sm">
